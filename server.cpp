...
int main(int argc, char *argv[])
{
	...
	server_address.sin_port = htons(8008);   // DOWOLNY SWOBODNY PORT	
			...
			while (true)
			{
				...
				if(turn == 1)
				{
					...
					if(user_input == "1" || user_input == "2" || user_input == "3" || user_input == "4" || user_input == "5" || user_input == "6" || user_input == "7" || user_input == "8" || user_input == "9")
					{
						...
						else if(user_input == "2"){grid[1][0] = 1;}
						else if(user_input == "3"){grid[2][0] = 1;}
						else if(user_input == "4"){grid[0][1] = 1;}
						else if(user_input == "5"){grid[1][1] = 1;}
						else if(user_input == "6"){grid[2][1] = 1;}
						else if(user_input == "7"){grid[0][2] = 1;}
						else if(user_input == "8"){grid[1][2] = 1;}
						else if(user_input == "9"){grid[2][2] = 1;}
